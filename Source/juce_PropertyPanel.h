...
#ifndef JUCE_myPropertyPanel_H_INCLUDED
#define JUCE_myPropertyPanel_H_INCLUDED
...
class JUCE_API  myPropertyPanel  : public PropertyComponent
{
public:
    //==============================================================================
    ...
    /** Creates an empty property panel. */
    myPropertyPanel (const String& name);
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (myPropertyPanel)
};


#endif   // JUCE_myPropertyPanel_H_INCLUDED
