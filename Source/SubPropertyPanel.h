...
#ifndef JUCE_SubPropertyPanel_H_INCLUDED
#define JUCE_SubPropertyPanel_H_INCLUDED
...
class   SubPropertyPanel : public PropertyComponent, public ValueListener
{
public:
	//==============================================================================
	...
	/** Creates an empty property panel. */
	SubPropertyPanel(const String& name,int height);
	...
	*/
	...
	public:
		...
		/** Called when a SubPropertyPanel's selected has changed. */
		virtual void selectedChanged(SubPropertyPanel* PanelThatHasChanged, const int indexSection) = 0;
...
private:
	...
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(SubPropertyPanel)
};
/** This typedef is just for compatibility with old code - newer code should use the Label::Listener class directly. */
typedef SubPropertyPanel::Listener SubPropertyPanelListener;
