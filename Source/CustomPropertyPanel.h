...
#ifndef JUCE_CUSTOMPROPERTYPANEL_H_INCLUDED
#define JUCE_CUSTOMPROPERTYPANEL_H_INCLUDED
...
class   CustomPropertyPanel : public Component, public ValueListener
{
public:
	//==============================================================================
	...
	/** Creates an empty property panel. */
	CustomPropertyPanel(const String& name);
	...
	*/
	...
	public:
		...
		/** Called when a CustomPropertyPanel's selected has changed. */
		virtual void selectedChanged(CustomPropertyPanel* PanelThatHasChanged, const int indexSection) = 0;
...
private:
	...
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CustomPropertyPanel)
};
/** This typedef is just for compatibility with old code - newer code should use the Label::Listener class directly. */
typedef CustomPropertyPanel::Listener CustomPropertyPanelListener;
