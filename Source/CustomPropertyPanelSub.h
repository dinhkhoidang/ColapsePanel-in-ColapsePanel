...
#ifndef JUCE_CustomPropertyPanelSub_H_INCLUDED
#define JUCE_CustomPropertyPanelSub_H_INCLUDED
...
class   CustomPropertyPanelSub : public PropertyComponent, public ValueListener
{
public:
	//==============================================================================
	/** Creates an empty property panel. */
	CustomPropertyPanelSub();
	CustomPropertyPanelSub(int height);

	/** Creates an empty property panel. */
	CustomPropertyPanelSub(const String& name,int height);
	...
	*/
	...
	public:
		...
		/** Called when a CustomPropertyPanelSub's selected has changed. */
		virtual void selectedChanged(CustomPropertyPanelSub* PanelThatHasChanged, const int indexSection) = 0;
...
private:
	...
	int height;
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(CustomPropertyPanelSub)
};
/** This typedef is just for compatibility with old code - newer code should use the Label::Listener class directly. */
typedef CustomPropertyPanelSub::Listener CustomPropertyPanelSubListener;
