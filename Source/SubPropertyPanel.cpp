...
struct SubPropertyPanel::SectionComponent : public Component
{
	...
	void setOpen(const bool open)
	{
		if (isOpen != open)
		{
			...
			if (SubPropertyPanel* const pp = findParentComponentOfClass<SubPropertyPanel>()) {
				pp->resized();
	...
	bool isOpenState;
	Colour bordercolor;
	SubPropertyPanel parent;
	int index;
	JUCE_DECLARE_NON_COPYABLE(SectionComponent)
};

//==============================================================================
struct SubPropertyPanel::PropertyHolderComponent : public Component
{
...
//==============================================================================
SubPropertyPanel::SubPropertyPanel():PropertyComponent("SubPropertyPanel")
{
	init();
}

SubPropertyPanel::SubPropertyPanel(const String& name, int _height) :height(_height), PropertyComponent(name, _height)
{
	init();
}

void SubPropertyPanel::init()
{
...
SubPropertyPanel::~SubPropertyPanel()
{
	listeners.clear();
	clear();
...
//==============================================================================
void SubPropertyPanel::paint(Graphics& g)
{
	if (isEmpty())
	{
...
void SubPropertyPanel::valueChanged(Value &)
{

}

void SubPropertyPanel::callChangeListeners( )
{

	Component::BailOutChecker checker(this);
	listeners.callChecked(checker, &SubPropertyPanelListener::selectedChanged, this, indexActive);  // (can't use Label::Listener due to idiotic VC2005 bug)
}



void SubPropertyPanel::addListener(SubPropertyPanelListener * listener)
{
	listeners.add(listener);
}

void SubPropertyPanel::removeListener(SubPropertyPanelListener * listener)
{
	listeners.remove(listener);
}

//==============================================================================
void SubPropertyPanel::clear()
{
	if (!isEmpty())
	{
...
bool SubPropertyPanel::isEmpty() const
{
	return propertyHolderComponent->sections.size() == 0;
}

int SubPropertyPanel::getTotalContentHeight() const
{
	return propertyHolderComponent->getHeight();
}


void SubPropertyPanel::addProperties(const Array<PropertyComponent*>& newProperties,const int titleHeight)
{
	if (isEmpty())
		repaint();
...
void SubPropertyPanel::addSection(const String& sectionTitle,
	const Array<PropertyComponent*>& newProperties,
...
void SubPropertyPanel::updatePropHolderLayout() const
{
...
void SubPropertyPanel::refreshAll() const
{
	propertyHolderComponent->refreshAll();
}

void SubPropertyPanel::refresh()
{
	refreshAll();
}
...
//==============================================================================
StringArray SubPropertyPanel::getSectionNames() const
{
	StringArray s;
...
bool SubPropertyPanel::isSectionOpen(const int sectionIndex) const
{
...
void SubPropertyPanel::setSectionOpen(const int sectionIndex, const bool shouldBeOpen)
{
...
void SubPropertyPanel::setSectionEnabled(const int sectionIndex, const bool shouldBeEnabled)
{
	if (SectionComponent* s = propertyHolderComponent->getSectionWithNonEmptyName(sectionIndex))
		s->setEnabled(shouldBeEnabled);
}

void SubPropertyPanel::removeSection(int sectionIndex)
{
	if (SectionComponent* s = propertyHolderComponent->getSectionWithNonEmptyName(sectionIndex))
	{
...
//==============================================================================
XmlElement* SubPropertyPanel::getOpennessState() const
{
...
void SubPropertyPanel::restoreOpennessState(const XmlElement& xml)
{
...
//==============================================================================
void SubPropertyPanel::setMessageWhenEmpty(const String& newMessage)
{
...
void SubPropertyPanel::setCollapseAll()
{
	propertyHolderComponent->collapseAll();
}

const String& SubPropertyPanel::getMessageWhenEmpty() const noexcept
{
